...
<html lang="<?= $userLangFromServer; ?>">
  <head>
    ...
    <meta name="description" content="results For <?= $q; ?>">
      ...
      <div class="row">
        <div class="col" id="content">
          <div class="logo flex-on-top on-top py-2">
            ...
            document.querySelector(".title").style.fontSize="1.8em";
            document.querySelector(".title").innerHTML=`#<?= $q; ?> Not Found!`;
            </script>
          <?php for($i = 0;$i < count($dir_names );$i++):?>
          <?php if($paths[$i] != ""): ?>
          <?php
        $extensions = array_reverse($db_upload["extension"]);
        $dates = array_reverse($db_upload["Date_Upload"]);
        ...
        $dir_names = array_reverse($db_upload["dir_name"]);
          ...
          ?>
          <?php foreach($tags as $j => $tag):?>
            <?php if(str_replace("#","",$tag) === $q):?>
            ...
            <div class="info mx-2 mt-1">
              ...
              <p class="desc-post my-1"><b><?= $author; ?> </b><span>
                <?= $desc; ?>
                <br/>
                <br/>
                <br/>
            ...
            <script>
            document.title=`#<?= $q; ?><?=" | ".$author;?>`;
            //document.querySelector(".title").style.fontSize="1.8em";
            document.querySelector(".title").innerHTML=`#<?= $q; ?>`;
            </script>
            <?php endif;  ?>
          <?php endforeach; ?>
          <?php endif; ?>
